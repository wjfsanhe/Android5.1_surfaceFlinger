        ...
        sp<IBinder>* handle, sp<IGraphicBufferProducer>* gbp)
{
	...
	case ISurfaceComposerClient::eFXSurfaceFront:
            result = createFrontLayer(client,
...
status_t SurfaceFlinger::createFrontLayer(const sp<Client>& client,
        ...
        sp<IBinder>* handle, sp<IGraphicBufferProducer>* gbp, sp<Layer>* outLayer)
{
    ...
    *outLayer = new LayerBF(this, client, name, w, h, flags);
    ...
    ALOGD("setBuffers return %p",(*gbp).get());
    ALOGE_IF(err, "***createLayerBF() failed (%s)", strerror(-err));
    return err;
}
